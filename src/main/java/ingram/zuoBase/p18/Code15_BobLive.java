...
public class Code15_BobLive {
    ...
    long process20230713(int N,int M,int row,int col,int rest){
        ...
        long live = process20230713(N,M,row - 1,col,rest - 1);
        live = process20230713(N,M,row +1,col,rest - 1);
        live = process20230713(N,M,row ,col- 1,rest - 1);
        live = process20230713(N,M,row,col + 1,rest - 1);
